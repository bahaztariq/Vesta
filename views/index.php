            ...
            <div class="swiper mySwiper w-full h-full">
                <div class="swiper-wrapper">
                    ...
                    <div onclick="window.location.href='Rooms.php'" class="swiper-slide cursor-pointer group">
                        <div class="flex flex-col gap-2 w-full">
                            <div class="aspect-square w-full relative overflow-hidden rounded-xl">
                                <img class="object-cover h-full w-full group-hover:scale-110 transition duration-300" src="../uploads/swiper/listing_1.jpg" alt="Listing">
                    ...
                    <div onclick="window.location.href='Rooms.php'" class="swiper-slide cursor-pointer group">
                        <div class="flex flex-col gap-2 w-full">
                            <div class="aspect-square w-full relative overflow-hidden rounded-xl">
                                <img class="object-cover h-full w-full group-hover:scale-110 transition duration-300" src="../uploads/swiper/listing_2.jpg" alt="Listing">
                                <div onclick="event.stopPropagation()" class="absolute top-3 text-xl right-3 text-orange-600/70 hover:text-orange-600 transition">
                                    <i class="fa-regular fa-heart"></i>
                                </div>
                            </div>
                    ...
                    <div onclick="window.location.href='Rooms.php'" class="swiper-slide cursor-pointer group">
                        <div class="flex flex-col gap-2 w-full">
                            <div class="aspect-square w-full relative overflow-hidden rounded-xl">
                                <img class="object-cover h-full w-full group-hover:scale-110 transition duration-300" src="../uploads/swiper/listing_3.jpg" alt="Listing">
                                <div onclick="event.stopPropagation()" class="absolute top-3 text-xl right-3 text-orange-600/70 hover:text-orange-600 transition">
                                    <i class="fa-regular fa-heart"></i>
                                </div>
                            </div>
                    ...
                    <div onclick="window.location.href='Rooms.php'" class="swiper-slide cursor-pointer group">
                        <div class="flex flex-col gap-2 w-full">
                            <div class="aspect-square w-full relative overflow-hidden rounded-xl">
                                <img class="object-cover h-full w-full group-hover:scale-110 transition duration-300" src="../uploads/swiper/listing_4.jpg" alt="Listing">
                                <div onclick="event.stopPropagation()" class="absolute top-3 text-xl right-3 text-orange-600/70 hover:text-orange-600 transition">
                                    <i class="fa-regular fa-heart"></i>
                                </div>
                            </div>
                    ...
                    <div onclick="window.location.href='Rooms.php'" class="swiper-slide cursor-pointer group">
                        <div class="flex flex-col gap-2 w-full">
                            <div class="aspect-square w-full relative overflow-hidden rounded-xl">
                                <img class="object-cover h-full w-full group-hover:scale-110 transition duration-300" src="../uploads/swiper/listing_5.jpg" alt="Kyoto Listing">
                                <div onclick="event.stopPropagation()" class="absolute top-3 text-xl right-3 text-orange-600/70 hover:text-orange-600 transition">
                                    <i class="fa-regular fa-heart"></i>
                                </div>
                            </div>
                    ...
                    <div onclick="window.location.href='Rooms.php'" class="swiper-slide cursor-pointer group">
                        <div class="flex flex-col gap-2 w-full">
                            <div class="aspect-square w-full relative overflow-hidden rounded-xl">
                                <img class="object-cover h-full w-full group-hover:scale-110 transition duration-300" src="../uploads/swiper/listing_6.jpg" alt="Bali Listing">
                                <div onclick="event.stopPropagation()" class="absolute top-3 text-xl right-3 text-orange-600/70 hover:text-orange-600 transition">
                                    <i class="fa-regular fa-heart"></i>
                                </div>
                            </div>
                    ...
                    <div onclick="window.location.href='Rooms.php'" class="swiper-slide cursor-pointer group">
                        <div class="flex flex-col gap-2 w-full">
                            <div class="aspect-square w-full relative overflow-hidden rounded-xl">
                                <img class="object-cover h-full w-full group-hover:scale-110 transition duration-300" src="../uploads/swiper/listing_7.jpg" alt="NYC Listing">
                                <div onclick="event.stopPropagation()" class="absolute top-3 text-xl right-3 text-orange-600/70 hover:text-orange-600 transition">
                                    <i class="fa-regular fa-heart"></i>
                                </div>
                            </div>
